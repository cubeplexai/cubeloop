...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L176)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L335)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L341)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L344)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L352)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L355)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L359)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L362)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L485)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L586)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L609)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L728)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L899)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L918)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L926)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L1047)
...
AgentState(
    system_prompt: str = '',
    model: Model = (lambda: Model(id='unknown', provider_id='unknown'))(),
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/agent.py#L134)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/loop.py#L38)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/loop.py#L103)
...
Turn an async function into an [`AgentTool`](./cubeloop-agent#agenttool).
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/tool_decorator.py#L180)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/tools.py#L419)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L96)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L81)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L56)
...
- `attempt_id`: `str | None`
- `turn_id`: `str | None`
- `turn_execution_context`: `Any`
- `on_turn_context`: `Callable[[Any], Any] | None`
- `set_input_admission`: `Callable[[bool], None] | None`
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L121)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L210)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L229)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L117)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L33)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L47)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L26)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L88)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L73)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L147)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L136)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L141)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L106)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L167)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L152)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L159)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L130)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/agent/types.py#L126)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/utils/emit.py#L7)
