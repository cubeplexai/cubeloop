...
Returns a [`MCPDiscoveryResult`](./cubeloop-mcp#mcpdiscoveryresult) carrying:
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/http_loader.py#L112)
...
Returns a [`MCPDiscoveryResult`](./cubeloop-mcp#mcpdiscoveryresult) with the same shape as
[`load_mcp_tools_http`](./cubeloop-mcp#load-mcp-tools-http): `tools` (executable AgentTools),
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/stdio_loader.py#L16)
...
MCPDiscoveryResult(
    ...
    tool_infos: list[MCPToolInfo] = list(),
)
```
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/types.py#L56)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/types.py#L10)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/types.py#L28)
...
```python
MCPToolInfo(name: str, icons: tuple[MCPIcon, ...] = ())
```
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/mcp/types.py#L43)
