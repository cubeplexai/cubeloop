---
id: cubeloop-middleware
title: cubeloop.middleware
sidebar_position: 5
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L34)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L37)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L46)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L51)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L59)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L67)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L87)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L96)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L99)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L108)
...
`provider.model(...)`. `cubeloop.tracing.Recorder` uses these to:
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L116)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L20)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/base.py#L145)


### TaskWaitBinding {#taskwaitbinding}

_class_

A successful host check bound to the checklist and committed input boundary.

[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L286)
...
### TaskWaitValidation {#taskwaitvalidation}

_class_

Host evidence; cancelled is only meaningful for a prior successful binding.

[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L296)
...
### TaskWaitValidator {#taskwaitvalidator}

_attribute_

```python
TaskWaitValidator: TypeAlias = Callable[[list[str], AgentContext, TaskWaitBinding | None], Awaitable[TaskWaitValidation]]
```


[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L304)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/compaction/__init__.py#L158)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/compaction/__init__.py#L197)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/compaction/__init__.py#L400)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/compaction/state.py#L19)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/goal.py#L73)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/goal.py#L84)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/goal.py#L87)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/goal.py#L122)



### ToolResultLimitMiddleware {#toolresultlimitmiddleware}
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/tool_result_limit.py#L67)
...
#### `after_tool_call` {#toolresultlimitmiddleware-after-tool-call}
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/tool_result_limit.py#L88)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/subagents.py#L103)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/subagents.py#L87)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/subagents.py#L95)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/subagents.py#L77)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L146)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L163)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main//opt/homebrew/Cellar/python@3.13/3.13.2/Frameworks/Python.framework/Versions/3.13/lib/python3.13/typing.py#L812)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L557)
...
#### `before_tool_call` {#todolistmiddleware-before-tool-call}
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L602)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L701)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L716)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L750)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L850)
...
[source](https://github.com/cubeplexai/cubeloop/blob/main/cubeloop/middleware/todo.py#L276)
