...
_LAZY = {
    ...
    "ToolResultLimitMiddleware": (
        "cubeloop.middleware.tool_result_limit",
        "ToolResultLimitMiddleware",
    ),
    ...
    "TaskWaitBinding": ("cubeloop.middleware.todo", "TaskWaitBinding"),
    "TaskWaitValidation": ("cubeloop.middleware.todo", "TaskWaitValidation"),
    "TaskWaitValidator": ("cubeloop.middleware.todo", "TaskWaitValidator"),
